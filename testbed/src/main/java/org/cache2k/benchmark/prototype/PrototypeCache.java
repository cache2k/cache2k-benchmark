...
public class PrototypeCache<E extends Entry<K,V>, K,V>
	...
	public PrototypeCache(final EvictionPolicy<K, V, E> eviction, Iterable<EvictionListener<K>> evictionListeners) {
