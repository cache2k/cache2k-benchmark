...
/**
 * Statistics of interesting eviction internals relevant for evaluation.
...
public interface EvictionStatistics {
	 ...
	 * A scan means the entry was accessed and includes the entry that is evicted.
	 */
	default long getScanCount() { return -1; }

	/**
	 * Counts a structural change in the data structures, to compare the amount of
	 * work done by the eviction algorithm, besides scanning. Mainly implemented
	 * for the Clock-Pro algorithms. A promotion, demotion or move to front counts
	 * as reshuffle. Operations for insertion or eviction are not counted reshuffle.
	 */
	default long getReshuffleCount() { return -1; }
