 ...
 * with different hit rates. Extended static pattern with 10M entries.
 *
 * @author Jens Wilke
 */
@State(Scope.Benchmark)
public class RandomAccessLongSequenceBenchmark extends BenchmarkBase {

  public static final int ENTRY_COUNT = 100 * 1000;
  public static final int PATTERN_COUNT = 10 * 1000 * 1000;
