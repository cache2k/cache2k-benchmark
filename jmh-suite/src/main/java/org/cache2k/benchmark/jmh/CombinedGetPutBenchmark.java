 ...
 */
@State(Scope.Group)
public class CombinedGetPutBenchmark {
  ...
  public void setup() throws Exception {
    ...
    BenchmarkCacheFactory _factoryInstance = (BenchmarkCacheFactory) Class.forName(this.cacheFactory).newInstance();
    cache = _factoryInstance.create(SIZE * 2);
