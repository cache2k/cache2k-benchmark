...
/**
 * Trace of database object access of a eCommerce web application during a busy daytime.
 *
 ...
 * @author Jens Wilke
 */
public class CacheAccessTraceOrmAccessBusy {

  public static AccessTrace getInstance() {
    return TraceCache.getTraceLazy("trace-mt-db-20160419-busy.trc.bin.bz2");
  }
