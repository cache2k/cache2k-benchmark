...
/**
 * Eviction algorithm based on the original CLOCK-Pro idea with simple
 * adaption.
 *
...
public class ClockPro implements ISimpleCache {
  ...
  public String getStatisticsString() {
    ...
    String result = String.format("avg. %f, hot hit %d, cold hit %d, cold hit tracked %d, cold access %d, test expire %d",
      avgHotRatio, this.hotHit, this.coldHit, this.coldHitTracked, this.coldAccess, this.testExpire);
    return result;
  }
