...
public class TraceCollections {
	...
	public final static EvictionMatrixTestBase.VariationBuilder ALL_TRACES = new EvictionMatrixTestBase.VariationBuilder()
		.add(Traces.SPRITE)
		.add(Traces.CPP)
		.add(Traces.MULTI2)
		.add(Traces.GLIMPSE)
		...
		.add(Traces.WEB07)
		.add(Traces.WEB12)
		.add(Traces.UMASS_FINANCIAL1_1ST1M)
		.add(Traces.UMASS_FINANCIAL2_1ST1M)
		.add(Traces.UMASS_WEBSEARCH1_1ST1M)
