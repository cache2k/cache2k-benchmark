...
/**
 * Build a caffeine simulator CAR policy
 *
 * @author Jens Wilke
 * @see CarPolicy
 */
public class CaffeineSimulatorCarPolicyFactory extends CaffeineSimulatorPolicyFactory<EvictionTuning.None> {
	...
	protected Policy createCaffeinePolicy(final Config configWithSize) {
		return new CarPolicy(configWithSize);
	}
